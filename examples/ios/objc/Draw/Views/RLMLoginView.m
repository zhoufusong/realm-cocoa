...
@interface RLMLoginView () <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>
...
- (void)didMoveToSuperview
{
    ...
    if (self.topCellBackgroundView == nil) {
        self.topCellBackgroundView = [[UIImageView alloc] initWithImage:[RLMLoginView cellBackgroundImageBottom:NO]];
    ...
    if (self.bottomCellBackgroundView == nil) {
        self.bottomCellBackgroundView = [[UIImageView alloc] initWithImage:[RLMLoginView cellBackgroundImageBottom:YES]];
